...
*/
bool srv_update_callback(final_project::UpdateObjectList::Request  &req,
         final_project::UpdateObjectList::Response &res)
{
    ...
    // newly added
    int new_idx = map_objs_.size() - 1;
    name2id[req.object_name] = new_idx;
    id2name[new_idx] = req.object_name;
...
/**
     ...
     */
    bool srv_get_scene_obj_callback(final_project::GetSceneObjectList::Request &req,
