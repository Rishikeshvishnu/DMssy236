...
public:
    ...
    DirectWorldInfo(ros::NodeHandle& nh)
    {
        ...
        //TODO: Fix the correct topic name as indicated in the slides (0.5 pts)
...
/**
  ...
  void topic_callback(const gazebo_msgs::ModelStates::ConstPtr& msg)
  {
    ...
    for (int i = 0; i < msg->name.size(); i++)
    {
        ...
        //Transform the TF object to a TF message
        ts.transform = tf2::toMsg(tf);

        // Set the reference frame for the TF (parent link)
        //TODO: You need to also make some modification to the launch file. (1pt, look in the launch file)
